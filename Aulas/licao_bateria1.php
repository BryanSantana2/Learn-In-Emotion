...
<head>
    ...
    <title>Aula de Baixo 1 - Learn In Emotion</title>
...
<body class="bg-slate-50 font-sans text-slate-800">
    ...
    <header class="bg-white border-b border-slate-200 p-4 sticky top-0 z-30 shadow-sm flex justify-between items-center">
        <div class="flex items-center gap-4">
            <!-- Alterado hover para amber-600 para combinar com a Area do Aluno -->
            <a href="../area_aluno.php" class="text-slate-500 hover:text-amber-600 transition p-2 rounded-full hover:bg-slate-100">
                <i class="fas fa-arrow-left text-xl"></i>
            </a>
            <div>
                <h1 class="font-bold text-lg leading-tight">Introdução à Bateria</h1>
    ...
    <main class="container mx-auto max-w-4xl p-4 md:p-8">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-slate-100 p-6 mb-8">
            <!-- Alterado de blue-900 para amber-900 -->
            <h2 class="text-2xl font-bold mb-4 text-amber-900">Resumo da Aula</h2>
            <div class="prose max-w-none text-slate-600">
                <p class="mb-4">Bem-vindo à sua primeira aula de bateria! Hoje focamos nos fundamentos essenciais:</p>
                <ul class="list-disc pl-5 space-y-2 mb-4">
                    <li><strong>Postura:</strong> Como sentar corretamente no banco para evitar lesões.</li>
                    <li><strong>Pegada (Grip):</strong> A forma correta de segurar as baquetas (Match Grip).</li>
                    <li><strong>Peças da Bateria:</strong> Identificando Bumbo, Caixa e Chimbal.</li>
                </ul>
                <p>Pratique o exercício de "Semínimas" no pad de estudo por pelo menos 10 minutos antes de avançar.</p>
            </div>
        </div>

        <!-- Alterado tema do card de conclusão para Amber/Orange -->
        <div class="bg-gradient-to-br from-amber-50 to-white p-8 rounded-2xl border border-amber-100 text-center shadow-sm">
            <i class="fas fa-music text-4xl text-amber-400 mb-4 block"></i>
            <h3 class="font-bold text-xl text-amber-900 mb-2">Entendeu a função da bateria?</h3>
            <p class="text-amber-600/80 mb-6 max-w-md mx-auto">Conclua esta aula para começar a desenvolver seu ritmo.</p>
            
            <form action="../PHP/marcar_conclusao.php" method="POST">
                <input type="hidden" name="arquivo_licao" value="licao_bateria1"> 
                <input type="hidden" name="instrumento" value="bateria">
