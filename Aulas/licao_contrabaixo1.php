...
<body class="bg-slate-50 font-sans text-slate-800">
    ...
    <header class="bg-white border-b border-slate-200 p-4 sticky top-0 z-30 shadow-sm flex justify-between items-center">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h1 class="font-bold text-lg leading-tight">Notas no Braço</h1>
    ...
    <main class="container mx-auto max-w-4xl p-4 md:p-8">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-slate-100 p-6 mb-8">
            ...
            <h2 class="text-2xl font-bold mb-4 text-amber-900">Fundamentos do Contrabaixo</h2>
            <div class="prose max-w-none text-slate-600">
                <p class="mb-4">O baixo é a ponte entre o ritmo e a harmonia. Nesta aula:</p>
                <ul class="list-disc pl-5 space-y-2 mb-4">
                    <li>Técnica de Pizzicato (dedos indicador e médio).</li>
                    <li>Cordas Soltas (E A D G).</li>
                    <li>Encontrando as Tônicas no braço.</li>
                </ul>
            </div>
        </div>
        ...
        <div class="bg-gradient-to-br from-amber-50 to-white p-8 rounded-2xl border border-amber-100 text-center shadow-sm">
            ...
            <h3 class="font-bold text-xl text-amber-900 mb-2">Entendeu a função do baixo?</h3>
            <p class="text-amber-600/80 mb-6 max-w-md mx-auto">Conclua esta aula para começar a desenvolver seu groove.</p>
            
            <form action="../PHP/marcar_conclusao.php" method="POST">
                <input type="hidden" name="arquivo_licao" value="licao_contrabaixo1"> 
                <input type="hidden" name="instrumento" value="contrabaixo">
