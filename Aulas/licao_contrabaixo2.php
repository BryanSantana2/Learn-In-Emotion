...
<head>
    ...
    <title>Aula de Baixo 2 - Learn In Emotion</title>
...
<body class="bg-slate-50 font-sans text-slate-800">
    ...
    <header class="bg-white border-b border-slate-200 p-4 sticky top-0 z-30 shadow-sm flex justify-between items-center">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h1 class="font-bold text-lg leading-tight">Slap Básico</h1>
    ...
    <main class="container mx-auto max-w-4xl p-4 md:p-8">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-slate-100 p-6 mb-8">
            <h2 class="text-2xl font-bold mb-4 text-amber-900">Introdução ao Slap</h2>
            <div class="prose max-w-none text-slate-600">
                <p class="mb-4">Uma técnica percussiva essencial para baixistas modernos.</p>
                <ul class="list-disc pl-5 space-y-2 mb-4">
                    <li>Movimento do Polegar (Thumb).</li>
                    <li>O "Pluck" (Puxada) com o indicador.</li>
                    <li>Exercício de oitavas (Tônica e Oitava).</li>
                </ul>
            </div>
        </div>

        <div class="bg-gradient-to-br from-amber-50 to-white p-8 rounded-2xl border border-amber-100 text-center shadow-sm">
            <i class="fas fa-hand-rock text-4xl text-amber-400 mb-4 block"></i>
            <h3 class="font-bold text-xl text-amber-900 mb-2">Conseguiu tirar o som estalado?</h3>
            <p class="text-amber-600/80 mb-6 max-w-md mx-auto">Essa técnica exige prática. Marque a conclusão e continue treinando!</p>
            
            <form action="../PHP/marcar_conclusao.php" method="POST">
                <input type="hidden" name="arquivo_licao" value="licao_contrabaixo2"> 
