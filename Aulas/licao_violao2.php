...
<head>
    ...
    <title>Aula de Violão 2 - Learn In Emotion</title>
...
<body class="bg-slate-50 font-sans text-slate-800">
    ...
    <header class="bg-white border-b border-slate-200 p-4 sticky top-0 z-30 shadow-sm flex justify-between items-center">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h1 class="font-bold text-lg leading-tight">Batidas Pop</h1>
                <p class="text-xs text-slate-500">Módulo Básico • Aula 2</p>
            </div>
        </div>
    </header>
    ...
    <main class="container mx-auto max-w-4xl p-4 md:p-8">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-slate-100 p-6 mb-8">
            <h2 class="text-2xl font-bold mb-4 text-amber-900">Ritmo da Mão Direita</h2>
            <div class="prose max-w-none text-slate-600">
                <p class="mb-4">Agora que temos acordes, precisamos de ritmo! Vamos aprender:</p>
                <ul class="list-disc pl-5 space-y-2 mb-4">
                    <li>O conceito de "Levada" ou "Batida".</li>
                    <li>Batida Padrão Pop (Baixo, Baixo, Cima, Cima, Baixo, Cima).</li>
                    <li>Exercício de troca de acordes sem parar a mão direita.</li>
                </ul>
            </div>
        </div>
        ...
        <div class="bg-gradient-to-br from-amber-50 to-white p-8 rounded-2xl border border-amber-100 text-center shadow-sm">
            ...
            <h3 class="font-bold text-xl text-amber-900 mb-2">Pronto para tocar músicas?</h3>
            <p class="text-amber-600/80 mb-6 max-w-md mx-auto">Marque esta aula e prepare-se para o nível intermediário.</p>
            
            <form action="../PHP/marcar_conclusao.php" method="POST">
                <input type="hidden" name="arquivo_licao" value="licao_violao2"> 
                <input type="hidden" name="instrumento" value="violao">
