...
<head>
    ...
    <title>Aula de Bateria 2 - Learn In Emotion</title>
...
<body class="bg-slate-50 font-sans text-slate-800">
    ...
    <header class="bg-white border-b border-slate-200 p-4 sticky top-0 z-30 shadow-sm flex justify-between items-center">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h1 class="font-bold text-lg leading-tight">Ritmos Básicos</h1>
    ...
    <main class="container mx-auto max-w-4xl p-4 md:p-8">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-slate-100 p-6 mb-8">
            ...
            <div class="prose max-w-none text-slate-600">
                <p class="mb-4">Agora que você conhece as peças, vamos tocar nosso primeiro groove!</p>
                <ul class="list-disc pl-5 space-y-2 mb-4">
                    <li>Contagem de tempo (1, 2, 3, 4).</li>
                    <li>Coordenação Bumbo e Caixa.</li>
                    <li>Manutenção do tempo no Chimbal (Colcheias).</li>
                </ul>
            </div>
        </div>
        ...
        <div class="bg-gradient-to-br from-amber-50 to-white p-8 rounded-2xl border border-amber-100 text-center shadow-sm">
            <i class="fas fa-check-circle text-4xl text-amber-400 mb-4 block"></i>
            <h3 class="font-bold text-xl text-amber-900 mb-2">Dominou o ritmo?</h3>
            <p class="text-amber-600/80 mb-6 max-w-md mx-auto">Marque como concluído para avançar no seu progresso.</p>
            
            <form action="../PHP/marcar_conclusao.php" method="POST">
                <input type="hidden" name="arquivo_licao" value="licao_bateria2"> 
