...
<head>
    ...
    <title>Aula de Violão 1 - Learn In Emotion</title>
...
<body class="bg-slate-50 font-sans text-slate-800">
    ...
    <header class="bg-white border-b border-slate-200 p-4 sticky top-0 z-30 shadow-sm flex justify-between items-center">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h1 class="font-bold text-lg leading-tight">Acordes Maiores</h1>
    ...
    <main class="container mx-auto max-w-4xl p-4 md:p-8">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-slate-100 p-6 mb-8">
            <h2 class="text-2xl font-bold mb-4 text-amber-900">Fundamentos do Violão</h2>
            <div class="prose max-w-none text-slate-600">
                <p class="mb-4">Bem-vindo ao mundo das seis cordas! Hoje vamos aprender:</p>
                <ul class="list-disc pl-5 space-y-2 mb-4">
                    <li>Postura e numeração dos dedos.</li>
                    <li>Nome das cordas soltas (E A D G B E).</li>
                    <li>Seus primeiros acordes: Lá Maior (A) e Mi Maior (E).</li>
                </ul>
            </div>
        </div>

        <div class="bg-gradient-to-br from-amber-50 to-white p-8 rounded-2xl border border-amber-100 text-center shadow-sm">
            <i class="fas fa-guitar text-4xl text-amber-400 mb-4 block"></i>
            <h3 class="font-bold text-xl text-amber-900 mb-2">Conseguiu fazer o som soar limpo?</h3>
            <p class="text-amber-600/80 mb-6 max-w-md mx-auto">Registre sua evolução clicando abaixo.</p>
            
            <form action="../PHP/marcar_conclusao.php" method="POST">
                <input type="hidden" name="arquivo_licao" value="licao_violao1"> 
